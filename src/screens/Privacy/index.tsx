...
const PrivacyPolicy: React.FC = () => {
  return (
    <Container sx={{ py: 4 }}>
      ...
      <br /> <br />
      ① 정보주체는 근육맨(‘https://muscleman.kr’이하 ‘근육맨) 에 대해 언제든지
      ...
      <br /> <br />①
      <em>(&apos;https://muscleman.kr&apos;이하 &apos;근육맨&apos;)</em>
      ...
      <br /> <br /> <br />
      <b>
        5. 개인정보의 파기<em>(&apos;근육맨&apos;)</em>은(는) 원칙적으로
      ...
      <br />
      ① 근육맨 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로
      ...
      <ul>
        <li>
          쿠키의 사용 목적 : 이용자가 방문한 각 서비스와 웹 사이트들에 대한 방문
      ...
      <br /> <br /> <b>7. 개인정보 보호책임자 작성</b>
      <br />
      ① 근육맨(‘https://muscleman.kr’이하 ‘근육맨) 은(는) 개인정보 처리에 관한
      ...
      직급 :대표
      <br />
      연락처 :01024148641, goorea1026@gmail.com,
      <br /> <br />
      ② 정보주체께서는 근육맨(‘https://muscleman.kr’이하 ‘근육맨) 의 서비스(또는
      사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
      피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
      있습니다. 근육맨(‘https://muscleman.kr’이하 ‘근육맨) 은(는) 정보주체의
      문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
      <br /> <br /> <b>8. 개인정보 처리방침 변경 </b>
      <br />
      ...
      <br /> <br />
      <b>
        9. 개인정보의 안전성 확보 조치 <em>(&apos;근육맨&apos;)</em>은(는)
        개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한
        기술적/관리적 및 물리적 조치를 하고 있습니다.
      </b>
      <br />
      1. 해킹 등에 대비한 기술적 대책
      <br /> &lt;<em>근육맨</em>&gt;(&apos;<em>근육맨</em>&apos;)은 해킹이나
